"use strict";
let userOnWebsiteStartDate;
let userOnCurrentPageStartDate;
...
function calculateSpentTime(startDate) {
...
function setSpentTimeValue() {
    const timeSpentElement = document.getElementById('footer__total-spent-time-value');
...
function showTotalSpentTime() {
    const timeSpentList = document.getElementById('footer__time-spent-list');
    const timeSpentOnCurrentPageListItem = document.getElementById('footer__time-spent-on-current-page-list-element');
    const showTotalTimeButton = document.getElementById('footer__show-total-time-button');
...
function setSpentTimeOnCurrentPageValue() {
    const timeSpentOnCurrentPageElement = document.getElementById('footer__spent-time-on-current-page-value');
